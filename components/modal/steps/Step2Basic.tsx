...
interface Step2BasicProps {
  ...
  /** When true, monthlyCost is derived from the wizard — hide the field */
  hideCost?: boolean;
}
    ...
    <div className="flex flex-col gap-5">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">
          {hideCost
            ? 'Name this decision and set the start date.'
      ...
      {/* Monthly Cost — hidden for wizard types that derive cost */}
      {!hideCost && (
